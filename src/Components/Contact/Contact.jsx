...
const Contact = () => {
  return (
    ...
    <div className='h2'>
          ...
          <h2>Follow us</h2>
          <div className='icons row text-center'>
          <div className='icon-card col-md-3'>
          {/* <Instagram/>
           */}
        </div>
        </div>
