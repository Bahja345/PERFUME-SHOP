...
const Reviews = () => {
  return (
    <div className='h1' id="Reviews">
      <h1>Customer Reviews</h1>
      <div className='reviews row text-center'>
        <div className='review-card col-md-4'>
...
<p style={{fontSize:"15px", textAlign:"center"}}>- William K.</p>
        ...
        <div className='review-card col-md-4'>
          <img src={image2} alt="Customer" className='img-fluid rounded-circle' width={"120px"} />
<p style={{fontSize:"13px", textAlign:"center"}}>"The customer service at Perfume Palace is exceptional. They helped me find the perfect scent for my wedding day!"</p>
<p style={{fontSize:"15px", textAlign:"center"}}>- John D.</p>
    </div>
